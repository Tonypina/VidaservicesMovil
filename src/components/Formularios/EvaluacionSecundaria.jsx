...
const EvaluacionSecundaria = ({ onFormSubmit }) => {
  return (
    <Formik
      initialValues={{
        alergias: "",
    ...
    >
      {({ handleChange, handleBlur, handleSubmit, values }) => (
        <View>
          ...
          <Text style={styles.layoutFormulario}>Padecimientos crónicodegenerativos: </Text>
          <TextInput
          ...
          <Text style={styles.layoutFormulario}>Antecedentes quirúrgicos: </Text>
          <TextInput
